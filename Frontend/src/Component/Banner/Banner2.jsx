...
const Banner2 = ({ data }) => {
  return (
    <div className="min-h-[550px] flex justify-center item-center py-12 mt-20">
        ...
        >
          ...
          <div className="h-full flex item-center">
            <img
              src={data.image}
              alt=""
              className="scale-125 w-{20px} md:w-{310px} mx-auto  drop-shadow-2xl object-cover"
            />
          </div>
          {/* Third-col */}
          <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
            ...
            <div>
              <button className="bg-white  text-brandYellow py-2 px-4 rounded-2xl mt-5">
                Shop Now
              </button>
            </div>
          </div>
